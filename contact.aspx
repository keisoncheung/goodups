<%@ Page Title="" Language="C#" MasterPageFile="~/mar.master" AutoEventWireup="true" CodeFile="contact.aspx.cs" Inherits="contact" %>
   ...
   <div><form action="" method="post" name="sform">
	...
	<div class="float_r">
		<div class="mainright_1">
		   ...
		   <div class="float_r  mainright_text "><a href="index.aspx">首页</a> > <a href="contact.aspx?id=4">联系我们</a> > <%=title %> </li></div>
		</div>
