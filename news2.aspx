<%@ Page Title="" Language="C#" MasterPageFile="~/mar.master" AutoEventWireup="true" CodeFile="news2.aspx.cs" Inherits="news2" %>
   ...
   <DIV class=left-title ><img src="images/news_p.gif" /></DIV>
	<div id="mainleft" >
		<UL id=leftmenu>
		  ...
		  <LI class=cur><A href='news2.aspx?type=54'>行业新闻</A> </LI>
		</UL>
   <P>&nbsp;</P>
   ...
   <div><form action="" method="post" name="sform">
	...
	<div class="float_r">
		<div class="mainright_1">
		   ...
		   <div class="float_r  mainright_text "><a href="index.aspx">首页</a> > <a href="news2.aspx?type=42">新闻动态</a> > <%=titles()%></li></div>
		</div>
