<%@ Page Title="" Language="C#" MasterPageFile="~/mar.master" AutoEventWireup="true" CodeFile="aboutus.aspx.cs" Inherits="aboutus" %>
...
<!--左边-->
 <div  class="mainleft_1">
   <DIV class=left-title ><img src="images/about_us.gif" /></DIV>
	<div id="mainleft" >
		<UL id=leftmenu>
		  <%=articletype()%>
		</UL>
   ...
   <div><form action="" method="post" name="sform">
	...
	<div class="float_r">
		<div class="mainright_1">
		   ...
		   <div class="float_l " ><img src="images/socend_jieshao.gif" /></div>
		   <div class="float_r "><img src="images/socend_p_r.gif" /></div>
		   <div class="float_r  mainright_text "><a href="index.aspx">首页</a> > <a href='aboutus.aspx?id=1'>关于我们</a> > <%=title %></div>
		</div>
